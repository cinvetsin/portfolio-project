...
export default function ContactSection() {
  return (
    <section id="contact" className="mt-10 text-center">
      <h4 className="text-2xl font-bold text-blue-500 font-comingSoon">Feel free to contact me!</h4>
      <div className="mt-4 flex font-comingSoon font-bold justify-center space-x-4">
        {/* Email */}
        <Link
          href="mailto:sashanabilafortuna@gmail.com"
          className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-black transition-colors duration-300"
        >
